<div class="row">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="name" value="{{ $row->name ?? old('name') }}"
                    placeholder="@lang('inputs.name')" required>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="email" class="form-control" name="email" value="{{ $row->email ?? old('email') }}"
                    placeholder="@lang('inputs.email')" required>
            </div>
    ...
    <div class="col-md-3">
        {{-- START USER IMAGE --}}
        @include('backend.includes.forms.input-file', [
...
<div class="row">
    <div class="col-md-4">
        {{-- START balance --}}
        <div class="form-group">
            <label class="required">@lang('inputs.balance')</label>
            <div class="input-group">
                <div class="input-group-prepend">
                    <span class="input-group-text"> <i class="fa fa-envelope"></i> </span>
                </div>
    ...
    <div class="col-md-4">
        {{-- START DEPARTMENT --}}
        <x-html.select name='department_id' :list="$departments" :selected="old('department_id', $row->department_id ?? null)" required="required" :label="trans('inputs.select-data', ['data' => trans('menu.department')])" />
        {{-- END DEPARTMENT --}}
    </div>
</div>
...
{{-- START ROLES --}}
<div class="form-group">
    <x-html.select name='roles[]' :list="$roles" :selected="old(
        'roles[]',
        isset($row)
            ? $row
                ->roles()
