                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <select style="height: 52px;" class="form-control" name="from_user_id">
                                        <option value="">"--- @lang('inputs.select-data', ['data' => trans('menu.from_users')]) ---"</option>
                                        @foreach ($users as $id => $name)
                                            <option value="{{ $id }}" @selected(request()->from_user_id == $id)>
                                                {{ $name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <select style="height: 52px;" class="form-control" name="to_user_id">
                                        <option value="">"--- @lang('inputs.select-data', ['data' => trans('menu.to_users')]) ---"</option>
                                        @foreach ($users as $id => $name)
                                            <option value="{{ $id }}" @selected(request()->to_user_id == $id)>
                                                {{ $name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group ">
                                    <input placeholder="الفترة من" autocomplete="off" style="direction: rtl;" id="fromdate"
                                        name="fromdate" value="{{ request()->fromdate }}" type="date"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <input placeholder="الفترة إلى" autocomplete="off" style="direction: rtl;"
                                        id="todate" name="todate" value="{{ request()->todate }}" type="date"
                                        class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select style="height: 52px;" name="status" class="form-control">
                                        ...
                                        @foreach ($typeList as $type)
                                            <option {{ request()->status == $type ? 'selected' : '' }}
                                                value="{{ $type }}">
                                                {{ $type }}
                                            </option>
                                        @endforeach
