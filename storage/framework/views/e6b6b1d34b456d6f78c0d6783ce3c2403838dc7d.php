<div class="card-header bg-main">
    <h4 class="card-title white">
        <i class="fas fa-edit"></i><span class="mx-1"><?php echo e($title ?? trans('menu.edit-row', ['model' => trans('menu.'.getModel(true))])); ?></span>
    </h4>
...
<div class="card-content collpase show">
    <div class="card-body">
        <form action="<?php echo e(routeHelper(getModel().'.update', $row)); ?>" method="post" class="<?php echo e($use_form_ajax ? 'submit-form' : ''); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/html/transactions-mangament/resources/views/backend/includes/forms/form-update.blade.php ENDPATH**/ ?>