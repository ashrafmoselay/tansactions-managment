    ...
    <div class="col-md-9">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="name" value="<?php echo e($row->name ?? old('name')); ?>" placeholder="<?php echo app('translator')->get('inputs.name'); ?>" required>
            </div>
...
<?php endif; ?>
    ...
    <div class="col-md-3">
        ...
        <?php echo $__env->make('backend.includes.forms.input-file', ['image' => isset($row) && $row->image ? url($row->image) : null, 'alt' => $row->name ?? null], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="password" class="form-control" name="password" placeholder=" <?php echo app('translator')->get('inputs.password'); ?>" <?php echo e(isset($row) ? '' : 'required'); ?>>
            </div>
            <?php if (isset($component)) { $__componentOriginalc98491cb9bb70c86f130d42eb4cfbfb99411b399 = $component; } ?>
...
<div class="form-group">
    <?php if (isset($component)) { $__componentOriginalb8781bb3916d84129d989465bf31332ffd2d4246 = $component; } ?>
<?php $component = App\View\Components\Html\Select::resolve(['name' => 'roles[]','list' => $roles,'selected' => old('roles[]', (isset($row) ? $row->roles()->pluck('id')->toArray() : [])),'label' => trans('inputs.select-data', ['data' => trans('menu.roles')])] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('html.select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Html\Select::class))->getConstructor()): ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/dftrecom/elansari.dftre.com/resources/views/backend/users/form.blade.php ENDPATH**/ ?>