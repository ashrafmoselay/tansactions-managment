<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow menu-bordered">
    <div class="main-menu-content ps-container ps-theme-dark ps-active-y">
        <form style="border-radius: 3px; border: 1px solid #b0bec5; margin: 10px 10px;display: none;" action="#" method="get" class="sidebar-form">
...
<?php /**PATH /var/www/html/transactions-mangament/resources/views/layouts/includes/backend/sidebar.blade.php ENDPATH**/ ?>